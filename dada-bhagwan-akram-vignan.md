---
layout: default
title: "Dada Bhagwan Philosophy and Akram Vignan"
description: "Akram Vignan, Jain foundations, Vedantic parallels, karma, non-doership, Self-realization, and distinctive teachings."
---

[![DADA BHAGWAN GURUPURNIMA 2025](https://tse3.mm.bing.net/th/id/OIP.hm3fNYPLJodL3r5bt6uf4wHaKl?r=0\&pid=Api)](https://dadabhagwangurupurnima.com/index.php?utm_source=chatgpt.com)
...
```mermaid
flowchart LR
    A["Ignorance<br/>'I am this body and personality'"]
    B["Ego and doership<br/>'I am doing this'"]
    C["New karma is charged"]
    D["Gnan Vidhi<br/>Separation of Self and non-Self"]
    E["Awareness<br/>'I am Pure Soul'"]
    F["Five Agnas<br/>Living as Knower-Seer"]
    G["Past karma discharges<br/>without new bondage"]
    H["Final liberation<br/>Moksha"]
    ...
    C -.->|"cycle of rebirth continues until Self-realization"| A
```
...
```mermaid
flowchart TB
    U["Beginningless Universe"]

    S["Soul<br/>Chetan / Jiva"]
    P["Matter<br/>Pudgal"]
    SP["Space<br/>Akash"]
    T["Time<br/>Kaal"]
    M["Medium supporting motion<br/>Gatisahayak"]
    R["Medium supporting rest<br/>Sthitisahayak"]
    ...
    S --- X["Interactions produce<br/>temporary states and phases"]
    P --- X
    SP --- X
    T --- X
    M --- X
...
flowchart TB
    ...
    REL["Relative viewpoint<br/>Vyavahar"]
    REAL["Real viewpoint<br/>Nischay"]

    PERSON --> REL
    PERSON --> REAL

    REL --> R1["Name and body"]
    REL --> R2["Mind, speech and behavior"]
    REL --> R3["Family and social roles"]
    REL --> R4["Karmic personality"]

    REAL --> S1["Pure Soul"]
    REAL --> S2["Knower-Seer"]
    REAL --> S3["Permanent consciousness"]
    REAL --> S4["Non-doer"]

    NOTE["Both viewpoints are used:<br/>do not deny worldly responsibilities,<br/>but do not mistake them for the permanent Self."]
...
```mermaid
flowchart LR
    I["Inner intent and doership<br/>Cause"]
    C["Charge karma"]
    N["Future circumstances"]
    E["External action and experience<br/>Effect"]
    D["Discharge karma"]
    ...
    D -.->|"if ego reacts with new attachment or hatred"| I
```
...
flowchart TB
    ...
    R --> V["Vyavasthit:<br/>result of all assembled evidences"]
```
...
```mermaid
flowchart LR
    subgraph K["Kramik — gradual path"]
        K1["Ethical discipline"] --> K2["Renunciation and purification"]
        K2 --> K3["Right vision and knowledge"]
        K3 --> K4["Liberation"]
    end

    subgraph A["Akram — step-less path"]
        A1["Meet the Gnani"] --> A2["Gnan Vidhi"]
        A2 --> A3["Immediate conviction<br/>'I am Pure Soul'"]
        A3 --> A4["Discharge remaining karma<br/>through the Five Agnas"]
        A4 --> A5["Liberation"]
    end
```
...
```mermaid
flowchart TB
    G["Self-realization through Gnan Vidhi"]

    A1["Separate Real from relative"]
    A2["See Pure Soul in others"]
    A3["Understand results as vyavasthit"]
    A4["Settle files with equanimity"]
    A5["Remain in the Gnani's awakened guidance"]
    ...
    A1 --> P["Awareness protected"]
    A2 --> P
    A3 --> P
    A4 --> P
    A5 --> P

    P --> D["Karmic discharge without<br/>new attachment or hatred"]
```
...
flowchart LR
    M["A mistake occurs"]
    A["Alochana<br/>Recognize and confess"]
    P["Pratikraman<br/>Repent and ask forgiveness"]
    R["Pratyakhyan<br/>Resolve not to repeat"]
    C["Reduced hostility and<br/>karmic entanglement"]
...
```mermaid
flowchart LR
    A["Present human life"]
    B["Gnan Vidhi<br/>Self-realization"]
    C["Follow Five Agnas<br/>and discharge karma"]
    D["Future birth under favorable<br/>spiritual circumstances"]
    E["Connection with<br/>Simandhar Swami"]
    F["Keval Gnan<br/>complete knowledge"]
    G["Final moksha"]
...
```mermaid
flowchart LR
    J["Jain metaphysics<br/>Soul, karma, six substances,<br/>Tirthankara, pratikraman"]
    V["Vedantic language<br/>Self-realization,<br/>Knower-Seer, non-doership"]
    B["Bhakti and guru principle<br/>Grace, surrender,<br/>living enlightened teacher"]
    M["Modern practical vocabulary<br/>Science, files,<br/>charge-discharge, evidence"]
    ...
    A --> N["Distinctive method:<br/>Gnan Vidhi first,<br/>purification afterward"]
```
